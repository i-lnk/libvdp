...
typedef enum 
{
	...
	IOTYPE_USER_IPCAM_SET_MDP_REQ				= 0x806,	// â€¦Ã‹Ã·âˆšâ€œâˆ†âˆ‚Ã˜â€™Ãâ‰¤â€šâ‰¤Å’Â ËÂ«ÃŽÂ«Ã›Å“ËšÅ“Â¢
	IOTYPE_USER_IPCAM_SET_MDP_RESP				= 0x807,	// â€¦Ã‹Ã·âˆšâ€œâˆ†âˆ‚Ã˜â€™Ãâ‰¤â€šâ‰¤Å’Â Ëâ€Â¶Â¥ï£¿Å“ËšÅ“Â¢
	IOTYPE_USER_IPCAM_GET_MDP_REQ				= 0x808,	// ÂªÃ’Â»Â°â€œâˆ†âˆ‚Ã˜â€™Ãâ‰¤â€šâ‰¤Å’Â ËÂ«ÃŽÂ«Ã›Å“ËšÅ“Â¢
	...
	IOTYPE_USER_IPCAM_PARING_RF_EXIT_REQ		= 0x870,	// ÍË³ö RF Éè±¸Åä¶Ô	
	IOTYPE_USER_IPCAM_PARING_RF_EXIT_RESP		= 0x871,	// ÍË³ö RF Éè±¸Åä¶ÔÓ¦´ð
	...
	IOTYPE_USER_IPCAM_GET_AUDIO_GAIN_REQ		= 0x8b0,	// »ñÈ¡ÒôÁ¿
	IOTYPE_USER_IPCAM_GET_AUDIO_GAIN_RESP 		= 0x8b1,	// »ñÈ¡ÒôÁ¿Ó¦´ð
	IOTYPE_USER_IPCAM_SET_AUDIO_GAIN_REQ		= 0x8b2,	// ÉèÖÃÒôÁ¿
	IOTYPE_USER_IPCAM_SET_AUDIO_GAIN_RESP 		= 0x8b3,	// ÉèÖÃÒôÁ¿Ó¦´ð
	...
	IOTYPE_USER_IPCAM_SET_DOOROPEN_REQ			= 0x1810,	//ÉèÖÃ¿ªÃÅ
	IOTYPE_USER_IPCAM_SET_DOOROPEN_RESP 		= 0x1811,	//ÉèÖÃ¿ªÃÅÓ¦´ð
	IOTYPE_USER_IPCAM_GET_DOOROPEN_REQ			= 0x1812,	//»ñÈ¡ÃÅËø×´Ì¬
	IOTYPE_USER_IPCAM_GET_DOOROPEN_RESP 		= 0x1813,	//»ñÈ¡ÃÅËø×´Ì¬Ó¦´ð
...
//
// â€“ï¬âˆÆ’Ã¸â„¢Ã€Â¯âˆšâ€¹Â¬ÃŽÂ Ï€â€âˆšÂµÆ’Â ËÃ¦â€ºÎ©Â·Ï€Ï€
//
typedef struct{
...
typedef struct{
    unsigned char 	devType;			// è®¾å¤‡ç±»åž‹: 0-å¡ç‰‡æœº, 1-æ‘‡å¤´æœº, 2-é±¼çœ¼æ‘„åƒæœº...
    unsigned char 	netFamily;			// ç½‘ç»œæä¾›å•†: 1-è¿ˆç‰¹å¨è§†, 2-tutk...
    unsigned char 	serverID;			// æœåŠ¡å™¨ID: ä¿ç•™,é»˜è®¤ä¸º0
    ...
    unsigned char 	supportPTZ;			// æ”¯æŒptzæŽ§åˆ¶: æ”¯æŒä¸º1,ä¸æ”¯æŒä¸º0
	...
	char			supportWakeUpControl;	// ÏÔÊ¾»½ÐÑ¹¦ÄÜ¿ª¹ØÏî£¬1 Ö§³Ö£¬0 ²»Ö§³ÖË«Ïò¸Äµ¥ÏòÃÅÁå£¬ÉèÖÃÀ¸ÖÐ²»ÏÔÊ¾
	char			supportUnlock;
    char 			reserve2[45];		// ä¿ç•™2
...
typedef struct{
	unsigned int enable; // 0,¹Ø±ÕË«Ïò»½ÐÑ¹¦ÄÜ£¬1 ´ò¿ªË«Ïò»½ÐÑ
	unsigned char reserved[4];
